...
// Checkpoint 2 presentation, served at /deck. 9 slides; the dashboard and
// payment page each get a dedicated full-slide screenshot.
...
<section class="slide">
  ...
  <div class="display" style="font-size:62px;margin-top:44px;line-height:1.15;">
    Four invoices routed end-to-end.<br>Not mocked, not local.
  </div>
  <div class="cols" style="margin-top:72px;">
    <div class="col" style="width:820px;font-size:29px;line-height:1.6;color:var(--muted);">
      <p class="row" style="padding:30px 0;">invoice → payment link + QR → MetaMask payment → on-chain verification → automatic routing</p>
      <p class="row end" style="padding:30px 0;">Every movement linked to ArcScan. Conservation verified against both the ledger and on-chain balances.</p>
    </div>
    <div class="col" style="padding-left:120px;">
      <p style="font-size:26px;color:var(--muted);">Across four invoices</p>
      <p class="display" style="font-size:64px;margin-top:14px;">3.00 USDC in</p>
      <p style="font-size:34px;line-height:1.9;margin-top:26px;">
        <strong style="color:var(--river);">1.656 EURC</strong> Spend<br>
        <strong style="color:var(--reserve);">0.75 USDC</strong> Reserve<br>
        <strong style="color:var(--earn);">0.45 USDC</strong> Earn
      </p>
      <p style="font-size:24px;color:var(--muted);margin-top:22px;">Exact to the micro-dollar.</p>
    </div>
  </div>
...
<section class="slide" style="padding:70px 140px;">
  ...
  <div style="text-align:center;margin-top:26px;">
    <div class="card"><img src="https://raw.githubusercontent.com/PetrAnto/affluents/main/design/screenshots/dashboard.png" alt="Affluents dashboard — buckets, income chart, split rules, invoice ledger" style="max-height:800px;max-width:1560px;"></div>
  </div>
  <div class="footer"><span>Buckets, income over time, split rules, and every invoice with its ArcScan links.</span><span class="r">05</span></div>
</section>
...
<section class="slide" style="padding:70px 140px;">
  ...
  <span class="label" style="float:right;">Live · Arc testnet</span>
  <div style="text-align:center;margin-top:26px;">
    <div class="card"><img src="https://raw.githubusercontent.com/PetrAnto/affluents/main/design/screenshots/03-payment.png" alt="Affluents payment page — paid invoice with routing summary" style="max-height:800px;max-width:1560px;"></div>
  </div>
  <div class="footer"><span>A real paid invoice: verified on-chain, then split into Spend, Reserve, and Earn — automatically.</span><span class="r">06</span></div>
</section>
