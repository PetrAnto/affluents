...
// Final-submission presentation, served at /deck. 10 slides; the dashboard,
// payment page, and withdraw flow each get a dedicated visual slide. Keep in
// sync with design/deck-print.html (the PDF source).
...
<title>Affluents — Final Submission</title>
...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box;}
  ...
  .row.end{border-bottom:1.5px solid var(--contour);}
</style>
</head>
<body>
...
<section class="slide">
  <span class="label">Final submission · August 2026</span>
  ...
  <div style="text-align:center;padding-top:130px;">
    ...
    <div class="display" style="font-size:52px;margin-top:44px;">One payment in.<br>Your money routes itself.</div>
...
<section class="slide">
  ...
  <div class="cols" style="margin-top:72px;">
    <div class="col" style="width:820px;font-size:29px;line-height:1.6;color:var(--muted);">
      <p class="row" style="padding:30px 0;">invoice → payment link + QR → wallet payment → on-chain verification → automatic routing → live USDC→EURC FX</p>
...
<section class="slide" style="padding:70px 140px;">
  <span class="label">The dashboard</span>
  <span class="label" style="float:right;">Live · Arc testnet</span>
  <div style="text-align:center;margin-top:26px;">
    <div class="card"><img src="https://raw.githubusercontent.com/PetrAnto/affluents/main/design/screenshots/dashboard-totals.png" alt="Affluents dashboard — buckets with provenance, income chart, split rule, exceptions" style="max-height:800px;max-width:1560px;"></div>
  </div>
  <div class="footer"><span>Buckets with withdrawal provenance, income over time, the split rule, and the exception hold — live.</span><span class="r">05</span></div>
</section>
...
<section class="slide" style="padding:70px 140px;">
  ...
  <span class="label" style="float:right;">Live · Arc testnet</span>
  <div style="text-align:center;margin-top:26px;">
    <div class="card"><img src="https://raw.githubusercontent.com/PetrAnto/affluents/main/design/screenshots/pay-paid.png" alt="Affluents payment page — paid invoice with live-rate routing summary" style="max-height:800px;max-width:1560px;"></div>
  </div>
  <div class="footer"><span>A real paid invoice: verified on-chain, then split into Spend, Reserve, and Earn — at a live FX rate.</span><span class="r">06</span></div>
</section>

<section class="slide">
  <span class="label">Withdraw from Earn</span>
  <span class="label" style="float:right;">Live · Arc testnet</span>
  <div class="cols" style="margin-top:64px;">
    <div class="col" style="width:820px;font-size:29px;line-height:1.6;">
      <div class="display" style="font-size:54px;line-height:1.2;">Money moves back out the same way it came in.</div>
      <p class="row" style="margin-top:48px;padding:28px 0;color:var(--muted);">Two journaled hops — vault redemption, then transfer — each intent-logged before dispatch, each confirmed on ArcScan.</p>
      <p class="row end" style="padding:28px 0;color:var(--muted);">One withdrawal at a time, by design. Conservation holds to the unit: Earn −0.80, Reserve +0.80, vault position −0.80 on-chain.</p>
    </div>
    <div class="col" style="padding-left:100px;vertical-align:middle;">
      <div class="card"><img src="https://raw.githubusercontent.com/PetrAnto/affluents/main/design/screenshots/withdraw-confirm-card.png" alt="Withdraw confirm step — Move 0.25 USDC from Earn to Reserve?" style="width:640px;"></div>
      <div style="height:36px;"></div>
      <div class="card"><img src="https://raw.githubusercontent.com/PetrAnto/affluents/main/design/screenshots/withdraw-defluence-pending-card-1.png" alt="Withdrawal in progress — defluence animation" style="width:640px;"></div>
    </div>
  </div>
  <div class="footer"><span>The defluence — the confluence run in reverse — captured during the real 0.80 withdrawal.</span><span class="r">07</span></div>
</section>
...
<section class="slide">
  ...
  <div class="cols" style="margin-top:56px;font-size:28px;line-height:1.5;">
    ...
    <div class="col">
      ...
      <p class="row end" style="padding:28px 0;">156 tests across worker, orchestrator, and the shared amounts library — including a deposit-wallet concurrency test.</p>
    </div>
  </div>
  <div class="footer"><span>affluents</span><span class="r">08</span></div>
</section>
...
<section class="slide">
  ...
  <div style="margin-top:56px;font-size:30px;line-height:1.5;">
    ...
    <p class="row" style="padding:32px 0;"><strong>Arc App Kit</strong> — live USDC→EURC swaps with a journaled slippage ladder and oracle guard</p>
    <p class="row end" style="padding:32px 0;"><strong>USDC + EURC</strong> — pay in USDC, hold Spend in EURC; multi-currency by default</p>
  </div>
  <div class="footer"><span>affluents</span><span class="r">09</span></div>
</section>

<section class="slide">
  <span class="label">Shipped since Checkpoint 2</span>
  <div class="cols" style="margin-top:64px;">
    <div class="col" style="width:880px;font-size:30px;line-height:1.5;">
      <p class="row" style="padding:28px 0;">Arc App Kit live USDC→EURC FX — journaled tolerance ladder, oracle guard</p>
      <p class="row" style="padding:28px 0;">Read-only client receipts — capability links, least-privilege lookups</p>
      <p class="row" style="padding:28px 0;">Withdraw from Earn — two journaled hops, crash-safe reconciliation</p>
      <p class="row" style="padding:28px 0;">Overpayment holds proven live — flagged, surfaced, never auto-routed</p>
      <p class="row end" style="padding:28px 0;">Remaining by Demo Day: the 3-minute video</p>
    </div>
